...
// OK
    hotbitApi.prototype.getMarketOrders = function (symbol)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.pending', {json:true, body: postbody}, function (error, response, body)
            {
...
// OK
    hotbitApi.prototype.createOrder = function (symbol, side, amount, price)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.put_limit', {json:true, body: postbody}, function (error, response, body)
            {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.pending', {json:true, body: postbody}, function (error, response, body)
            {
                ...
                for (i = 0; i < body.result.records.length; i++)
                {
                    ...
                    request.post(this.apiURL + '/order.cancel', {json:true, body: cpostbody}, function (error, response, body2) {});
    ...
    hotbitApi.prototype.getOrderById = function (symbol, clientOrderId)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.pending', {json:true, body: postbody}, function (error, response, body)
            {
                ...
                request.post(this.apiURL + '/order.finished', {json:true, body: postbody}, function (error, response, body2)
                {
                    ...
                    request.post(this.apiURL + '/order.finished', {json:true, body: postbody}, function (error, response, body3)
                    {
...
// OK
    hotbitApi.prototype.cancelOrderById = function (symbol, clientOrderId)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.cancel', {json:true, body: postbody}, function (error, response, body)
            {
...
// OK
    hotbitApi.prototype.getTradesByOrderId = function (orderId)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            request.post(this.apiURL + '/order.deals/', {json:true, body: postbody}, function (error, response, body)
            {
...
// OK
    hotbitApi.prototype.getAccountBalances = function (assets)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            var postbody = {api_key: this.api_key, sign: this.sign, assets: assets};
        
            request.post(this.apiURL + '/balance.query', {json:true, body: postbody}, function (error, response, body)
            {
